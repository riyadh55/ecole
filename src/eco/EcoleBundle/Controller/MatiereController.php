...
use eco\EcoleBundle\Entity\Matiere;
use eco\EcoleBundle\Form\MatiereType;
...
class MatiereController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ecoEcoleBundle:Matiere')->findAll();
     ...
     * @Method("POST")
     * @Template("ecoEcoleBundle:Matiere:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ecoEcoleBundle:Matiere')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ecoEcoleBundle:Matiere:edit.html.twig")
     */
