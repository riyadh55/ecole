...
use eco\EcoleBundle\Entity\Reglement;
use eco\EcoleBundle\Form\ReglementType;
...
class ReglementController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ecoEcoleBundle:Reglement')->findAll();
     ...
     * @Method("POST")
     * @Template("ecoEcoleBundle:Reglement:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ecoEcoleBundle:Reglement')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ecoEcoleBundle:Reglement:edit.html.twig")
     */
