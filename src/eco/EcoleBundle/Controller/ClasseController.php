...
use eco\EcoleBundle\Entity\Classe;
use eco\EcoleBundle\Form\ClasseType;
...
class ClasseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ecoEcoleBundle:Classe')->findAll();
     ...
     * @Method("POST")
     * @Template("ecoEcoleBundle:Classe:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ecoEcoleBundle:Classe')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ecoEcoleBundle:Classe:edit.html.twig")
     */
