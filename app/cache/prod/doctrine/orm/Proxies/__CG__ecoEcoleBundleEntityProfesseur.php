 ...
 */
class Professeur extends \eco\EcoleBundle\Entity\Professeur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'eco\\EcoleBundle\\Entity\\Professeur' . "\0" . 'id', '' . "\0" . 'eco\\EcoleBundle\\Entity\\Professeur' . "\0" . 'nom', '' . "\0" . 'eco\\EcoleBundle\\Entity\\Professeur' . "\0" . 'prenom', '' . "\0" . 'eco\\EcoleBundle\\Entity\\Professeur' . "\0" . 'dateNaissance', '' . "\0" . 'eco\\EcoleBundle\\Entity\\Professeur' . "\0" . 'genre', '' . "\0" . 'eco\\EcoleBundle\\Entity\\Professeur' . "\0" . 'specialite', '' . "\0" . 'eco\\EcoleBundle\\Entity\\Professeur' . "\0" . 'tauxHoraire');
        }
